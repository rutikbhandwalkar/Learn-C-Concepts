...
using namespace std;
 ...
 void cl_ob()
   {
    ...
    cout<<"\n\n\n1) What is class & object?\n\n2)  What is the General format of them?\n\n";
    cout<<"3) Show example.\n\n";
    cout<<"\n\t\t\t\t\t\t<< 0 for main menu>>";
    cout<<"\n\n\nENTER YOUR CHOICE:      ";
    cin>>c;
 ...
 \n\n\taccess specifier:data & functions\n\n\taccess specifier:data & functions\
 \n\n\t......\n.......\n};\n\n\n";
...
associated with a given procedure is not known until the time of the call \
...
supports the concept of hierarchial classification or reuseability property.";
    cout<<"\n\n\n\n\n\t\t\t->->->PRESS ENTER FOR NEXT<-<-<-";
    //getch();
    break;
       }
...
-----------------\n\n\n1> what is private,public & protected variables?\n\n\
